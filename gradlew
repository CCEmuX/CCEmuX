...
#    fi
#done
#Symlinks are handled natively and no need to resolve them

SAVED="$(pwd)"
cd "$(dirname \"$PRG\")" # No need for > /dev/null because cd throws only stderr output
APP_HOME="$(pwd -P)"
cd "$SAVED"
