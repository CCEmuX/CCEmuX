...
public class KeyTranslator {
	private static final ImmutableBiMap<Integer, Integer> gdxToCCMap = ImmutableBiMap.copyOf(new HashMap<Integer, Integer>() {{
		...
		put(Input.Keys.APOSTROPHE, 40);
		put(Input.Keys.GRAVE, 41);
		...
		put(Input.Keys.FORWARD_DEL, 211);
	}});
	...
	public static int translateToGDX(int keycode) {
		return gdxToCCMap.inverse().getOrDefault(keycode, 0);
	}
}
