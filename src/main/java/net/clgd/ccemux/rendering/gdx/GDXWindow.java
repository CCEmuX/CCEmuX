...
public class GDXWindow implements Renderer, InputProcessor, ApplicationListener {
	...
	GDXWindow(EmulatedComputer computer) {
	...
	public Vector2 getWindowSize() {
		int screenWidth = terminal.getWidth() * pixelWidth + margin * 2;
		int screenHeight = terminal.getHeight() * pixelHeight + margin * 2;
	...
	public void resize(int width, int height) {
		bgBatch.getProjectionMatrix().setToOrtho2D(0, 0, width, height);
		fgBatch.getProjectionMatrix().setToOrtho2D(0, 0, width, height);
	}
