...
public class EmulatedTerminal extends Terminal {
	...
	public void resize(int width, int height) {
		...
		for (Listener listener : listeners) listener.resize(width, height);
	}

	@Override
	public void setCursorPos(int x, int y) {
		super.setCursorPos(x, y);
		for (Listener listener : listeners) listener.setCursorPos(x, y);
	}

	@Override
	public void setCursorBlink(boolean blink) {
		super.setCursorBlink(blink);
		for (Listener listener : listeners) listener.setCursorBlink(blink);
	}

	@Override
	public void setTextColour(int colour) {
		super.setTextColour(colour);
		for (Listener listener : listeners) listener.setTextColour(colour);
	}

	@Override
	public void setBackgroundColour(int colour) {
		super.setBackgroundColour(colour);
		for (Listener listener : listeners) listener.setBackgroundColour(colour);
	}

	@Override
	public void blit(String text, String textColour, String backgroundColour) {
		super.blit(text, textColour, backgroundColour);
		for (Listener listener : listeners) listener.blit(text, textColour, backgroundColour);
	}

	@Override
	public void write(String text) {
		super.write(text);
		for (Listener listener : listeners) listener.write(text);
	}

	@Override
	public void scroll(int yDiff) {
		super.scroll(yDiff);
		for (Listener listener : listeners) listener.scroll(yDiff);
	}
	...
	public void clearLine() {
		super.clearLine();
		for (Listener listener : listeners) listener.clearLine();
	}
